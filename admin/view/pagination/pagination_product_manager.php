<nav class=" mb-4" aria-label="Page navigation example" style="display: flex; justify-content:center" ;>
    <ul class="pagination justify-content-center">
        ...
        for ($i = 1; $i <= $max_page; $i++) {
            if ($i == $num_page) {
                echo "
                    <li class='page-item active'><a class='page-link' href='index.php?page=admin_default&num_page=$i'>$i</a></li>";
            } else {
                echo "
                    <li class='page-item'><a class='page-link' href='index.php?page=admin_default&num_page=$i'>$i</a></li>";
            }
        }
